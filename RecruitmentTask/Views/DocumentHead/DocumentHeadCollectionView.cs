...
namespace RecruitmentTask.Views.DocumentHeadCollectionView{
    public partial class DocumentHeadCollectionView : XtraUserControl {
        public DocumentHeadCollectionView() {
            InitializeComponent();
        ...
        void InitBindings() {
            ...
            var fluentAPI = mvvmContext.OfType<RecruitmentTask.ViewModels.DocumentHeadCollectionViewModel>();
