...
namespace RecruitmentTask.Views.DocumentPositionCollectionView{
    public partial class DocumentPositionCollectionView : XtraUserControl {
        public DocumentPositionCollectionView() {
            InitializeComponent();
        ...
        void InitBindings() {
            ...
            var fluentAPI = mvvmContext.OfType<RecruitmentTask.ViewModels.DocumentPositionCollectionViewModel>();
